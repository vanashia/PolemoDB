...
endforeach()
if(NOT GPDB_HAVE_FLS)
  list(APPEND _gpdb_port_sources "${CMAKE_SOURCE_DIR}/src/port/fls.c")
endif()
if(NOT GPDB_HAVE_GETPEEREID AND NOT WIN32)
  list(APPEND _gpdb_port_sources "${CMAKE_SOURCE_DIR}/src/port/getpeereid.c")
endif()
...
set_target_properties(pgport PROPERTIES POSITION_INDEPENDENT_CODE ON)
...
set_target_properties(pgcommon PROPERTIES POSITION_INDEPENDENT_CODE ON)
...
set_target_properties(libpq PROPERTIES POSITION_INDEPENDENT_CODE ON)
